...
// Original terminal-based chat function (kept for fallback)
pub async fn chat_unlock(api_key: &str) -> Result<LockDecision> {
    ...
    println!("\n=== Productivity Chat Unlock ===");
    println!("Your screen has been locked due to procrastination detection.");
    println!("Please explain why you should be allowed to continue:");
